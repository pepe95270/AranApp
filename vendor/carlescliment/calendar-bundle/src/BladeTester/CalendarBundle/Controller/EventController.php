...
class EventController extends BaseController {
    ...
    {
        $calendar = $this->getCalendar();
        $event = $calendar->createEvent($this->getUser());
    ...
    public function listAction()
    {
        ...
        $events = $this->getCalendar()->findNextByUser($user);
    ...
    public function listByDayAction($year, $month, $day) {
        ...
        $events = $this->getCalendar()->findAllByDayByUser($day, $user);
        $collection = new EventCollection($events);
        return array(
            'events' => $collection,
            'current' => $day,
    ...
    public function listByWeekAction($year, $month, $day) {
        $user = $this->getUser()->getId();
        $day = new \DateTime("$year-$month-$day");
        $events = $this->getCalendar()->findAllByWeekByUser($day, $user);
        $collection = new EventCollection($events);
        return array(
            'events' => $collection,
            'current' => $day,
    ...
    public function listByMonthAction($year, $month) {
        ...
        $events = $this->getCalendar()->findAllByMonthByUser($day, $user);
        $collection = new EventCollection($events);
        return array(
            'events' => $collection,
