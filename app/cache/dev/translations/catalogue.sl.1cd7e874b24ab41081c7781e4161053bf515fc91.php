...
',
  ...
  'messages' => 
  array (
    'action.new' => 'Novo %entity_name%',
    'action.show' => 'Prikažite',
    'action.edit' => 'Urejanje',
    'action.search' => 'Iskanje',
    'action.delete' => 'Izbrišite',
    'action.save' => 'Shranite spremembe',
    'action.cancel' => 'Prekličite',
  ...
  'EasyAdminBundle' => 
  array (
    'new.page_title' => 'Ustvarite novo %entity_name%',
    'show.page_title' => '%entity_name% (#%entity_id%)',
    'edit.page_title' => '%entity_name% (#%entity_id%)',
    'list.page_title' => '%entity_name%',
    'search.page_title' => '{0} Rezultati niso bili najdeni|{1} <strong>1</strong> rezultat najden|{2} <strong>%count%</strong> rezultata najdena|{3} <strong>%count%</strong> rezultati najdeni|[5,Inf] <strong>%count%</strong>rezultatov najdenih',
    ...
    'label.empty' => 'Prazno',
    'label.null' => 'Null',
    'label.nullable_field' => 'Pustite prazno',
    ...
    'delete_modal.action' => 'Izbrišite',
    'action.add_new_item' => 'Dodajte nov element',
    'action.add_another_item' => 'Dodajte naslednji element',
    'action.remove_item' => 'Odstranite element',
    'errors' => 'Napaka|Napake',
  ),
));
