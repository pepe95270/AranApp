...
',
  ...
  array (
    ...
    'Deselect visible' => 'Отменить выделение видимых',
    'Deselect all' => 'Отменить выделение всех',
    'Action' => 'Действие',
    'Submit Action' => 'Выполнить',
    'From:' => 'С:',
    'To:' => 'По:',
    'eq' => 'Равно',
    'neq' => 'Не равно',
    ...
    'req' => 'Регулярное выражение',
    'like' => 'Содержит',
    'nlike' => 'Не содержит',
    'rlike' => 'Начинается с',
    'llike' => 'Оканчивается на',
    'btw' => 'Между (не включая)',
    'btwe' => 'Между (включительно)',
    'isNull' => 'Не определено (null)',
    'isNotNull' => 'Определено (не null)',
    '%count% Results, ' => '%count% Запись, |%count% Записи, |%count% Записей, ',
    'No result' => 'Нет записей для отображения',
    'Export' => 'Экспорт',
    'Reset' => 'Сброс',
  ),
  'VichUploaderBundle' => 
