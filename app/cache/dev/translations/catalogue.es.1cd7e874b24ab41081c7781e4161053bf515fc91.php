...
$catalogue = new MessageCatalogue('es', array (
  ...
  array (
    ...
    'bladetester_calendar.validation.event_dates' => 'La fecha fin de un evento no puede ser anterior a su comienzo.',
  ),
  'security' => 
  array (
...
',
  ...
  array (
    ...
    'No data' => 'Sin datos',
    'Export' => 'Exportar',
    'bladetester_calendar.label.event.add' => 'Añadir evento',
    'bladetester_calendar.label.event.update' => 'Actualizar evento',
    'bladetester_calendar.label.event.delete_warning' => '¿De verdad quieres eliminar este evento?',
    'bladetester_calendar.label.event_category.delete_warning' => '¿De verdad quieres eliminar esta categoría?',
    'bladetester_calendar.label.event.category.none' => 'Sin categoría',
    'bladetester_calendar.label.agenda' => 'Agenda',
    'bladetester_calendar.label.day' => 'Día',
    'bladetester_calendar.label.week' => 'Semana',
    'bladetester_calendar.label.month' => 'Mes',
    'bladetester_calendar.label.print' => 'Imprimir',
    'bladetester_calendar.label.settings' => 'Configurar',
    'bladetester_calendar.label.cancel' => 'Cancelar',
    'bladetester_calendar.label.configuration_parameters' => 'Parámetros de configuración',
    'bladetester_calendar.label.back_to_calendar' => 'volver al calendario',
    'bladetester_calendar.label.event.title' => 'Título',
    'bladetester_calendar.label.event.description' => 'Descripción',
    'bladetester_calendar.label.event.start' => 'Inicio',
    'bladetester_calendar.label.event.end' => 'Fin',
    'bladetester_calendar.label.event.category' => 'Categoría',
    'bladetester_calendar.label.category.add' => 'Crear categoría',
    'bladetester_calendar.title.category.add' => 'Crear nueva categoría',
    'bladetester_calendar.label.category.edit' => 'Actualizar',
    'bladetester_calendar.title.category.edit' => 'Editar categoría',
    'bladetester_calendar.label.delete' => 'Borrar',
    'bladetester_calendar.title.category.list' => 'Listado de categorías',
    'bladetester_calendar.label.category.name' => 'Nombre',
    'bladetester_calendar.label.category.color' => 'Color',
    'bladetester_calendar.label.settings.update' => 'Guardar',
    'bladetester_calendar.label.settings.default_view' => 'Vista predeterminada',
    'bladetester_calendar.list.no_events' => 'Aún no hay eventos',
    'bladetester_calendar.list.no_categories' => 'Aún no hay categorías',
    'bladetester_calendar.flash.event_added' => 'Se ha creado un nuevo evento de título "%title%"',
    'bladetester_calendar.flash.event_updated' => 'El evento "%title%" ha sido actualizado',
    'bladetester_calendar.flash.event_deleted' => 'El evento "%title%" ha sido eliminado',
    'bladetester_calendar.flash.category_added' => 'Se ha creado una nueva categoría de nombre %name%',
    'bladetester_calendar.flash.category_updated' => 'La categoría %name% ha sido actualizada',
    'bladetester_calendar.flash.category_deleted' => 'La categoría %name% ha sido eliminada',
    'bladetester_calendar.flash.settings_updated' => 'Configuración del calendario actualizada',
    'bladetester_calendar.exception.event_not_found' => 'No se encontró ningún evento con id %id%',
    'bladetester_calendar.exception.category_not_found' => 'No se encontró ninguna categoría con id %id%',
    '%month% of %year%' => '%month% de %year%',
    '%month%-%day%' => '%day%/%month%',
    'Week from %from_day%, %from_month% of %from_year% to %to_day%, %to_month% of %to_year%' => 'Semana del %from_day% de %from_month% de %from_year% al %to_day% de %to_month% de %to_year%',
    '%week_day%, %month% %day%th of %year%' => '%week_day%, %day% de %month% de %year%',
    'bladetester_calendar.abbr.monday' => 'lun',
    'bladetester_calendar.abbr.tuesday' => 'mar',
    'bladetester_calendar.abbr.wednesday' => 'mie',
    'bladetester_calendar.abbr.thursday' => 'jue',
    'bladetester_calendar.abbr.friday' => 'vie',
    'bladetester_calendar.abbr.saturday' => 'sáb',
    'bladetester_calendar.abbr.sunday' => 'dom',
    'January' => 'Enero',
    'February' => 'Febrero',
    'March' => 'Marzo',
    'April' => 'Abril',
